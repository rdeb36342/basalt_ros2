...
def generate_launch_description():
    ...
    cal_file = expanduser('~/bas_repo/src/basalt_ros/basalt_ros2/config/gazebo_calib.json')
    vio_file = expanduser('~/bas_repo/src/basalt_ros/basalt_ros2/config/gazebo_vio.json')    
    ...
    return launch.LaunchDescription([
            launch_ros.actions.Node(
                ...
                remappings=[('/left_image', '/camera/infra1/image_raw'),
                        ('/right_image', '/camera/infra2/image_raw'),
                        ('/imu_topics', '/iris/imu'),
